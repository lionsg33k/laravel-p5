...
<div class="mt-6 rounded-xl border border-gray-200 bg-white shadow-sm overflow-hidden">
    <div class="p-4">
        <div class="flex gap-3">
            <div class="flex h-10 w-10 items-center justify-center rounded-full bg-alpha/10 text-sm font-semibold text-alpha">
                JD
            </div>
    ...
    <article class="rounded-xl border border-gray-200 bg-white shadow-sm overflow-hidden">
        ...
        <div class="px-4 pb-3">
            <p class="text-gray-800 leading-relaxed">
                This is my first post! Excited to share updates here 🎉
            </p>
        </div>
